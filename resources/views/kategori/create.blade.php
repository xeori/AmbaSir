  ...
  <div class="card-body">
                    ...
                    <form action="{{ route('kategori.store') }}" class="forms-sample" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="exampleInputUsername1" autocomplete="off" placeholder="Masukan Nama Kategori">
