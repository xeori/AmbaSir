!function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        Z = e => z[e],
        X = e => {
                !e.backdrop && e.allowOutsideClick && r(
        ...
        m = () => document
                .body
                .querySelector(".".concat(p.container)),
        t = e => {
                const t = m();
                return t
                    ? t.querySelector(e)
        ...
        se = () => s(document.body, p.shown) && !s(document.body, p["toast-shown"]) && !s(
                document.body,
                p["no-backdrop"]
            ),
        ce = () => g() && s(g(), p.toast);
        ...
        y = (t, e) => {
                if (t.textContent = "", e) {
                    ...
                    Array
                        .from(o.querySelector("head").childNodes)
                        .forEach(e => {
                            t.appendChild(e)
                        }),
                    Array
                        .from(o.querySelector("body").childNodes)
                        .forEach(e => {
                            t.appendChild(e)
                        })
                }
        ...
        k = function (e) {
                e.style.display = 1 < arguments.length && void 0 !== arguments[1]
                    ? arguments[1]
                    : "flex"
            },
        B = e => {
        ...
        const He = (e, t) => {
            ...
            i && (
                ...
                n = i,
                (o = t.grow) && "string" == typeof o && (o = "grow-".concat(o)) in p && w(
                    n,
                    p[o]
                ),
                v(i, t, "container")
        ...
        De = (e, a) => {
                ...
                a.input && (c && (e => {
                    if (!L[e.input]) 
                        return l(
                            (
                                'Unexpected type of input! Expected "text", "email", "password", "number", "tel' +
                                '", "select", "radio", "checkbox", "textarea", "file" or "url", got "'
                            ).concat(e.input, '"')
                        );
                    const t = Re(e.input),
                        n = L[e.input](t, e);
                ...
                })(a), e = a, t = Re(e.input), "object" == typeof e.customClass && w(
                    t,
                    e.customClass.input
                ))
            },
                        ...
                        ? t.icon && -1 === Object
                            ...
                            .indexOf(t.icon)
                                ? (
                                    l(
                                        (
                                            'Unknown icon! Expected "success", "error", "warning", "info" or "question", go' +
                                            't "'
                                        ).concat(t.icon, '"')
                                    ),
                                    B(n)
        ...
        Je = (e, t) => {
                if (t.iconColor) {
                    ...
                    for (
                        const n of[".swal2-success-line-tip", ".swal2-success-line-long", ".swal2-x-mark-line-left", ".swal2-x-mark-line-right"]
                    ) 
        ...
        et = (e, n) => {
                ...
                k(o),
                o.textContent = "",
                n.currentProgressStep >= n.progressSteps.length && r(
        ...
        nt = (e, t) => {
                ...
                B(te());
                n = o;
                (n.className = "".concat(p.popup, " ").concat(
                    P(n)
                        ? t.showClass.popup
                        : ""
                ), t.toast)
        ...
        function ht(e) {
            (t = e).inputValidator || Object
                .keys(gt)
                .forEach(e => {
                    t.input === e && (t.inputValidator = gt[e])
                }),
            e.showLoaderOnConfirm && !e.preConfirm && r(
        ...
        wt = e => {
                ...
                return !(
                    ...
                    n === o || !(be(o) || "INPUT" === n.tagName || "TEXTAREA" === n.tagName || be(G()) && G().contains(n))
                )
            },
        Ct = () => {
                var e;
        ...
        xt = (e, t, n) => {
                ...
                n.heightAuto && n.backdrop && !n.toast && w([
                    document.documentElement, document.body
                ], p["height-auto"])
            },
        M = e => {
        ...
        Nt = (e, n, t) => {
                ...
                if (o && (!n.isComposing && 229 !== n.keyCode)) 
                    if (o.stopKeydownPropagation && n.stopPropagation(), "Enter" === n.key) 
                        ...
                        s = n,
                        i = o,
                        R(i.allowEnterKey) && s.target && e.getInput() && s.target instanceof HTMLElement && s.target.outerHTML === e
                            .getInput()
                            .outerHTML && (
        ...
        e = Object.freeze({
            ...
            showValidationMessage: function (e) {
                ...
                n.customClass && n.customClass.validationMessage && w(
                    t.validationMessage,
                ...
                e.popup.onclick = () => {
                    var e,
                        t = T
                            ...
                            .get(n);
                    t && (
                        (e = t).showConfirmButton || e.showDenyButton || e.showCancelButton || e.showCloseButton || t.timer || t.input
                    ) || o(S.close)
                }
            };
        let tn = !1;
        ...
        const cn = () => {
            if (x.timeout){{const n=ie();var e=parseInt(window.getComputedStyle(n).width),t=(n.style.removeProperty("transition"),n.style.width="100%",parseInt(window.getComputedStyle(n).width)),e=e/t*100;n.style.removeProperty("transition"),n.style.width="".concat(e,"%")}return x.timeout.stop()}},
            ln = () => {
                var e;
                if (x.timeout) 
                    return e = x
            ...
            const pn = t => {
                for (let e = t.target; e && e !== document; e = e.parentNode) 
                    for (const o in dn) {
                        ...
                        if (n) 
                            return void dn[o].fire({template: n})
                    }
                };
            ...
            const gn = (l, u, d) => new Promise((e, t) => {
                ...
                bn = (e, t, n) => {
                    ...
                    t.timer && (
                        ...
                        t.timerProgressBar && (k(o), v(o, t, "timerProgressBar"), setTimeout(() => {
                ...
                vn = (e, t) => t.focusDeny && P(e.denyButton)
                ...
                var Cn = (Cn = [
                    {
                        text: "В нижеприведённом видео объясняется как каждый из нас может помочь в том,\n   " +
                                "     <strong>чтобы эта бессмысленная и бесчеловечная война остановилась</stron" +
                                "g>:",
                        id: "4CfDhaRkw7I"
                    }, {
                        text: "Эмпатия - главное <strong>человеческое</strong> чувство. Способность сопережив" +
                                "ать. <strong>Способность поставить себя на место другого.</strong>",
                        id: "s-GLAIY4DXA"
                    }
                ])[Math.floor(Math.random() * Cn.length)];
                y(I, (
                    "\n      <div>\n        Если мы не остановим войну, она придет в дом <strong>ка" +
                    "ждого из нас</strong> и её последствия будут <strong>ужасающими</strong>.\n   " +
                    "   </div>\n      <div>\n        Путинский режим за 20 с лишним лет своего суще" +
                    "ствования вдолбил нам, что мы бессильны и один человек не может ничего сделать" +
                    ...
                    Cn.id,
                    '" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-m' +
                            'edia; gyroscope; picture-in-picture" allowfullscreen></iframe>\n      <div>\n ' +
                            '       Нет войне!\n      </div>\n      '
                ));
