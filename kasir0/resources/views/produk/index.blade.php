...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <a href="{{ route('admin.produk.create') }}" class="btn btn-success mb-3"><i class="fas fa-plus"></i> Add</a>
              <div class="card">
                  ...
                  <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <div class="modal fade" id="modal-hapus{{$pdt->id}}">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  <p>Are you sure dude? deleted data <b>{{$pdt->name}}</b></p>
                                </div>
                                <div class="modal-footer justify-content-between">
                                    <form action="{{route('admin.produk.destroy', ['id' =>$pdt->id]) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
